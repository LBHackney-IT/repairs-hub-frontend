...
const mockContracts = [
  ...
  },
  {
    ...
    terminationDate: '2025-05-28T00:00:00Z',
  ...
  },
  {
    ...
    terminationDate: '2025-09-15T23:00:00Z',
...
describe('Contracts dashboard component', () => {
  ...
  describe('filtered contracts', () => {
    it('returns contracts that will expire in two months', () => {
      const contracts = mockContracts

      const response = contracts.filter((contract) => {
        return (
